 ...
 * @param mappedFieldType  the {@link MappedFieldType} of the field, or {@code null} when
 *                         the mapper type is not known or not relevant for pipeline routing
 * @param isDimension      {@code true} when the field is a time-series dimension
 */
